...
import { useSchools, useResponsive, useOffline, useNetworkStatus } from '@hooks/index';
  ...
  return (
    <Card pressionavel onPress={handlePress} style={styles.card}>
      <View style={styles.cardContent}>
        <View style={[styles.iconContainer, !isMobile && styles.iconContainerLarge]}>
          <Ionicons name="school" size={isMobile ? 28 : 32} color={CORES.primaria} />
        </View>
    ...
    <View style={styles.headerBusca}>
      ...
      <View style={styles.contador}>
        <View style={styles.contadorEsquerda}>
          <Ionicons name="school-outline" size={16} color={CORES.textoSecundario} />
        ...
        {isOnline && (
          <Badge variante="sucesso" tamanho="sm">
            <Ionicons name="cloud-done" size={12} color={CORES.sucesso} /> Online
          </Badge>
        )}
      </View>
    </View>
